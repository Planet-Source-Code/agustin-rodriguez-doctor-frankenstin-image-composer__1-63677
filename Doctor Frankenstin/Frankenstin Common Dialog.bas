...
Function SaveDialog(Form1 As Form, Filter As String, DefaultEXT As String, Title As String, InitDir As String) As String
    Dim s As Integer
    ...
    If (A) Then
        ...
        s = InStr(SaveDialog, Chr(0))
        If s Then SaveDialog = Mid(SaveDialog, 1, s - 1)
    Else
        SaveDialog = ""
    End If
End Function
...
Function OpenDialog(Form1 As Form, Filter As String, Title As String, InitDir As String) As String
    ...
    If (A) Then
        ...
        s = InStr(OpenDialog, Chr(0))
        If s Then OpenDialog = Mid(OpenDialog, 1, s - 1)
    Else
        OpenDialog = ""
    End If
End Function
